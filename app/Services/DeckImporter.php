...
class DeckImporter
{
    ...
    protected function processCard(
        ...
        $attributes = [
            ...
            'card_order' => (int) ($cardData['order'] ?? 0),
            'archived' => (bool) ($cardData['archived'] ?? false),
            'done' => !empty($cardData['done']), // Convert datetime/string to boolean
            'notified' => (bool) ($cardData['notified'] ?? false),
            'comments_count' => (int) ($cardData['commentsCount'] ?? 0),
